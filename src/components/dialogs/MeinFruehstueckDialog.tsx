...
export function MeinFruehstueckDialog({ open, onClose, onSubmit, defaultValues, gaesteList, enablePhotoScan = true, enablePhotoLocation = true }: MeinFruehstueckDialogProps) {
