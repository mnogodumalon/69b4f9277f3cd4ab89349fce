...
export function FruehstuecksbestellungDialog({ open, onClose, onSubmit, defaultValues, gaesteList, fruehstuecksoptionenList, enablePhotoScan = false, enablePhotoLocation = true }: FruehstuecksbestellungDialogProps) {
